...
#TARGET_KERNEL_DEVICE_CONFIG := device_lge_vs995
TARGET_KERNEL_CONFIG := twrp_defconfig
TARGET_KERNEL_DEVICE_DEFCONFIG := device_lge_vs995

TARGET_PREBUILT_KERNEL := $(DEVICE_TREE)/Image-vs995.lz4-dtb
